...
mod tests {
    ...
    fn test_account_root_serde() {
        let account_root = AccountRoot::new(
            ...
            Some("13F1A95D7AAB7108D5CE7EEAF504B2894B8C674E6D68499076441C4837282BF8".to_string()),
            None,
            "rf1BiGeXwwQoi8Z2ueFYTEXSwuJYfV2Jpn".to_string(),
            3,
            "0D5FB50FA65C9FE1538FD7E398FFFE9D1908DFA4576D8D7A020040686F93C77D".to_string(),
            14091160,
            336,
            Some("0D5FB50FA65C9FE1538FD7E398FFFE9D1908DFA4576D8D7A020040686F93C77D".to_string()),
            Some("148446663".into()),
            None,
            Some("6D64756F31332E636F6D".to_string()),
            Some("98B4375E1D753E5B91627516F6D70977".to_string()),
            Some("0000000000000000000000070000000300".to_string()),
            None,
            None,
            None,
            None,
